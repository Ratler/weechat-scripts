...
if __name__ == "__main__" and import_ok:
    if weechat.register(SCRIPT_NAME, SCRIPT_AUTHOR, SCRIPT_VERSION, SCRIPT_LICENSE,
        ...
        weechat.hook_command(SCRIPT_COMMAND,
                             "Generate a One-Time Password (TOTP) for service authentication or login on connect on UnderNET.",
                             ...
                             "  /uotp otp undernet\n"
                             "  /uotp list\n"
                             "  /uotp add undernet 4c6fdb7d0659bae2a16d23bab99678462b9f7897\n"
                             "  /uotp add undernet jrx5 w7ig lg5o filn eo5l tfty iyvz 66ex\n"
                             "  /uotp remove undernet\n"
                             "  /uotp enable undernet\n"
                             "  /uotp disable undernet",
                             "otp %(irc_servers)"
                             " || list"
                             " || add %(irc_servers)"
